...
local hyc_role_mapping = {
        hycr_operator = {"/process/project/", "/process/order/", "/process/workorder/", "/process/detail/", "/process/reply/", "/drawing/detailWithProc/", "/drawing/queryByPage", "/deploy/", "/edgeNode/", "/retrieval/"}, 
        ...
        hycr_deployer = {"/deploy/", "/drawing/detailWithProc/", "/drawing/queryByPage", "/process/detail/", "/edgeNode/getInnerEdges", "/edgeNode/detail/", "/edgeNode/programDetail"}, 
