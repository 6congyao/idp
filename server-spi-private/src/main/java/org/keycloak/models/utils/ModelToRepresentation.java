...
public class ModelToRepresentation {
    ...
    public static final String HYC_ATTRIBUTE_KEY_TOTAL_USERS = "totalUsers";
    ...
    public static RoleRepresentation toRepresentation(KeycloakSession session, RealmModel realm, RoleModel role) {
        RoleRepresentation rep = new RoleRepresentation();
        rep.setId(role.getId());
        rep.setName(role.getName());
        rep.setDescription(role.getDescription());
        ...
        List<String> countList = new ArrayList<>();
        String countStr = String.valueOf(session.users().getRoleMembersStream(realm, role).count());
        countList.add(countStr);
